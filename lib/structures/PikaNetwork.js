...
const { PikaNetworkInterval, PikaNetworkMode, PikaNetworkGamemode, PikaNetworkLeaderboardType } = require("../index.js");
const { z } = require("zod");
...
module.exports = class PikaNetwork {
   ...
   * @param {import("../enums/PikaNetwork/Gamemode.js")[keyof import("../enums/PikaNetwork/Gamemode.js")]} gamemode The gamemode to check the total data of
   * @returns {Promise<import("../types/index.js").TotalLeaderboardEntry[]>}
   */
  async getTotalLeaderboard(gamemode) {
    const schema = z.enum(Object.values(PikaNetworkGamemode));
   ...
   * @param {import("../types/index.js").PikaNetworkGetLeaderboardOptions} options
   * @returns {Promise<import("../types/index.js").Leaderboard>}
   */
  async getLeaderboard(options) {
    options.limit ??= 15;
    options.interval ??= PikaNetworkInterval.Weekly;
    options.mode ??= PikaNetworkMode.AllModes;
    options.offset ??= 0;
    const schema = z.object({
      gamemode: z.enum(Object.values(PikaNetworkGamemode)),
      leaderboardType: z.enum(Object.values(PikaNetworkLeaderboardType)),
      interval: z.enum(Object.values(PikaNetworkInterval)),
      mode: z.enum(Object.values(PikaNetworkMode)),
  ...
  /**
   * Get the leaderboard of a gamemode with specific stats
   * @param {import("../types/index.js").PikaNetworkGetProfileLeaderboardOptions} options
